...
const loginQuery = 'SELECT * FROM userClients JOIN users ON users.id = userClients.userId JOIN clients ON clients.id = userClients.clientId WHERE username=? AND password=MD5(?);';
